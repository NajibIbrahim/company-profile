    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">Pembayaran</a></li>
          <li class="list-inline-item text-white h3 font-secondary @@nasted"></li>
        </ul>
        <p class="text-lighten">Disini bisa melakukan Cek Pembayaran Khusus Santri Putra, dengan memasukkan ID Santri masing-masing</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="row">
        <!-- <div class="col-12 bg-primary py-4 newsletter-block"> -->
          ...
          <div class="col-6 bg-primary py-2 newsletter-block">
            <div class="section-title text-center">
              <h3 class="text-white" align="center">Cari Pembayaran</h3>
              <form action="pembayaran.php">
                <div class="input-wrapper">
                  <input class="form-control border-0" name="cari" placeholder="Masukkan ID Santri...">
                  <button type="submit" value="send" class="btn btn-primary">Cari</button>
                </div>
              </form>
              <!-- disini kalo warna biru -->
            </div>
          </div>
          ...
          <!-- <div class="table-responsive">   -->
            ...
            if(isset($_GET['cari'])&&$_GET['cari']==NULL){
              ...
              echo "<center><h4><font color=#1B99B5>Silahkan Masukkan ID Santri !!!</font></h4><center><hr>";  
            } else  if(isset($_GET['cari'])){
              $cari = $_GET['cari'];
              $data = mysqli_query($conn,"SELECT * FROM santri WHERE id_san like '%".$cari."%'"); 
              ...
              while($d = mysqli_fetch_assoc($data)){
                ...
                <div>
                  ...
                  <table style="text-align: left;" border='0' class="table table-striped table-bordered table-hover">
                    ...
                    <table>
                    <tr><td>
                    <a href='exporttagihan.php?id_san=$d[id_san]' class='btn btn-primary'><i class='fa fa-square-o'>Cetak/Print</i></a>
                    </td></tr>
                    </table>"
                    ?>
                    <hr/>
                ...
                } else if(isset($_GET['cari'])&&$_GET['cari']!='id_san'){
                  // echo "<center><h4><font color='E62129'>ID Santri SALAH !!!</font></h4></center>";
                  echo "<center><h4><font color=#1B99B5>ID Santri  SALAH !!!</font></h4><center><hr>";  
