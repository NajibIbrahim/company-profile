...
<head>
  <meta charset="utf-8">
  <title>Acara Besar | Ponpes Al Hikmah Pedurungan Semarang</title>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary">Kegiatan</a></li>
          <li class="list-inline-item text-white h3 font-secondary nasted">Acara Besar</li>
        </ul>
        <p class="text-lighten">Informasi seputar acara-acara besar tahunan yang diadakan di Pondok Pesantren Al Hikmah Semarang.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row align-items-center mb-5">
      <div class="col-12 mt-0 order-4">
        <h2>Rangkaian Acara Besar Tahunan</h2>
      </div>
      <!-- border -->
