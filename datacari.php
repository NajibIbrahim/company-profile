...
<head>
  <meta charset="utf-8">
  <title>Data Santri | Ponpes Al Hikmah Pedurungan Semarang</title>
        ...
        <!-- <div class="col-12 bg-primary py-4 newsletter-block"> -->
          ...
          <div class="col-6 py-2 newsletter-block">
            <div class="text-center">
              <!-- <h3 class="text-white" align="center">Cari Santri</h3> -->
                  ...
                  <div> 
                    <table style="text-align: left;" border='0' class="">
                      <!-- <tr class="text-lighten"> -->
                        <tr>
                          <th width="160px"></th><td width="400px"><b><a href="lihatsantri.php?nama_san=<?= $d['nama_san'];?>"><?php echo $d['nama_san']; ?></a></b> <i><font color=#1B99B5>(<?php echo $d['status_san']; ?>)</font></i></td>
                        </tr>
                        <tr>
